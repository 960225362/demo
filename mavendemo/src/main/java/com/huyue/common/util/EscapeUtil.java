...
public class EscapeUtil {
    ...
    public static void main(String[] args) {
        // escape 一次，用于直接拿到cookie
        String stest
            = "%u9648%u5C11%u806A%2C%20220102199203120812%2C%20%u5409%u6797%u957F%u6625%u4E9A%u6CF0%u5927%u8857%2C%2019511960478%2C%2013675707570%20";
        // System.out.println(stest);
        // System.out.println(escape(stest));
        System.out.println(unescape("%u7535%u5546"));
        // unescape 两次，用于从request中拿到参数 转两次的escape参数，从request拿到的是null
        String test
            = "%25u7684%25u8BF4%25u6CD5%252C%2520%25u7684%25u8BF4%25u6CD5%252C%2520%25u7684%25u8BF4%25u6CD5%252C%2520%25u901F%25u5EA6111%252C%252013675707570%2520";
        System.out.println(test);
        System.out.println(escape(test));
        System.out.println(unescape(unescape(test)));
    }
}